...
ltn12 = require("ltn12")
json = require("json")
require("/etc/project_odoo/devices")
require("/etc/project_odoo/dhcp")
require("/etc/project_odoo/ip")
require("/etc/project_odoo/mac")
require("/etc/project_odoo/netmask")
require("/etc/project_odoo/password")
require("/etc/project_odoo/ssid")
require("/etc/project_odoo/time")
require("/etc/project_odoo/wireless")
require("/etc/project_odoo/site")
require("/etc/project_odoo/gateway")
